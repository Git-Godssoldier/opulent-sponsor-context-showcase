 ...
 *
 * Shipped, this renders the template's empty states rather than a demonstration built
 * from data nobody gathered. After a run it renders that run. The fallback is silent by
 * design: an empty packet is a legitimate state of this page, not an error.
 */
function loadPacket() {
  const root = resolve(process.cwd(), "..");
  for (const p of ["artifacts/packet.json", "templates/packet.template.json"]) {
    try {
