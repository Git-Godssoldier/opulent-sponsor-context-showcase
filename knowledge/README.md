...
3. The deck's promotional register stays in the deck; the email is written in the sender's register from `agency/trifecta-profile.md`. `skills/opulent-sponsor-context-showcase/scripts/lint_pitch.mjs` enforces both banned lists after every render.
