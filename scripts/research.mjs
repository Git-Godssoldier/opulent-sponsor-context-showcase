...
console.log("  2. Fill artifacts/signal.json — a date and a verbatim quote, then reason_eligible: true");
console.log("  3. Write judgement into artifacts/dossier.json — fit.band, fit.rationale,");
